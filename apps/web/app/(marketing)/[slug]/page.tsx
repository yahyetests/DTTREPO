...
export default function GenericMarketingPage({ params }: { params: { slug: string } }) {
  ...
  if (params.slug === 'about-the-lms') {
    const vmpCards = [
      { data: differentiators.vision, icon: <Eye className="w-6 h-6" />, color: "from-blue-500 to-indigo-600" },
      { data: differentiators.mission, icon: <Target className="w-6 h-6" />, color: "from-amber-500 to-orange-600" },
      { data: differentiators.process, icon: <Compass className="w-6 h-6" />, color: "from-emerald-500 to-teal-600" },
    ];
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-primary text-white py-20">
          <div className="container-custom text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{takweenStory.headline}</h1>
