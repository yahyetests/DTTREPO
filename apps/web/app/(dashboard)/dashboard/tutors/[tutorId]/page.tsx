            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                                ...
                                <div className="flex gap-2">
                                    <Button variant="outline" size="icon" aria-label="Favorite tutor" className="h-9 w-9 rounded-full text-slate-400 hover:text-red-500 hover:bg-red-50 border-slate-200 ">
                                        <Heart className="w-4 h-4" />
                                    </Button>
                                    <Button variant="outline" size="icon" aria-label="Share profile" className="h-9 w-9 rounded-full text-slate-400 hover:text-primary hover:bg-white border-slate-200 ">
                            ...
                            <div className="mt-5 pt-5 border-t border-slate-100">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {tutor.subjects.map(sub => (
                                        <span key={sub} className="px-2.5 py-1 rounded-md bg-white border border-slate-100 text-slate-700 text-xs font-medium">
                                            {sub}
                                        </span>
                                    ))}
                                </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                        ...
                        {/* Rating Breakdown */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 p-6 bg-white/50 rounded-xl border border-slate-100">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-lg sticky top-24 overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            {selectedDate !== null ? (
                                ...
                                <div className="h-24 flex items-center justify-center bg-white rounded-xl border border-dashed border-slate-200 text-slate-400 text-sm">
