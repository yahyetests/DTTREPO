      ...
      <div className="container-custom grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            A different kind of tuition agency, built on precision, care, and results. Smart LMS technology + outstanding tutors = measurable progress every step of the way.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-slate-400">
            <li className="flex items-start gap-3">
              ...
              <a href="mailto:info@takweentutors.com" className="hover:text-white transition-colors">info@takweentutors.com</a>
            </li>
            <li className="flex items-start gap-3">
